...
def preprocess_text_classification(
    ...
    encoded_example = tokenizer(s.replace("movie_",""), max_length=512)
    # 各IDがどのトークンを表すかを表示
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Evaluate a movie.')

    # Add arguments
    parser.add_argument('--bert', default = "bert-base-uncased", type=str, help='Username of the evaluator')
    parser.add_argument('--token_user', default=0,  type=int, help='Item ID of the movie')
    parser.add_argument('--token_movie', default=0, type=int, help='Item ID of the movie')
    parser.add_argument('--token_rating', default=0, type=int, help='Item ID of the movie')
    parser.add_argument('--remove_MASK', default=0,  type=int, help='Rating given to the movie')
    parser.add_argument('--remove_SEP', default=0,  type=int, help='Rating given to the movie')
    parser.add_argument('--remove_user', default=0,  type=int, help='Rating given to the movie')
    parser.add_argument('--remove_movie', default=0,  type=int, help='Rating given to the movie')

    # Parse the arguments
    args = parser.parse_args()

    remove_MASK=args.remove_MASK
    remove_SEP=args.remove_SEP
    remove_user=args.remove_user
    remove_movie=args.remove_movie
