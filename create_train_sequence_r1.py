      ...
      for _ in range(rep_num):
          for index, row in df_valid.iterrows():
              ...
              if not user_info.empty:
                  ...
                  #ターゲットムービーを選択
                  target_movie_id = f"movie_{str(int(row['movieId']))}"
                  ...
                  selected_indices = random.sample([i for i in range(threshold) if movies[i] !=target_movie_id], seq_num)
                  ...
                  user_sequence = user_sequence+" "+result+" " + SEP +" "+ target_movie_id  + " " + MASK
